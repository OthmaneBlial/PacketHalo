...
Recorded sessions replay the versioned local recording format. A future router adapter will be another plugin and must authenticate to its device locally. Neither feature is allowed to introduce a hosted relay.
